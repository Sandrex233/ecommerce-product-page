    ...
    return (
        <div>
            {count === 0 || !isClicked || isCleared
                ?
                <div className="absolute right-12 mt-5  bg-white flex flex-col justify-center space-y-4 p-4 items-center shadow-[0_35px_60px_-15px_rgba(0,0,0,0.2)]  border-2 border-gray-600 rounded-md">
                    <h1 className="font-bold">Cart</h1>
                    <p className="text-gray-500">Your cart is empty.</p>
                </div>
                :
                <div className='absolute right-12 mt-5 max-w-md max-h-52 bg-white flex flex-col justify-center space-y-4 p-4 items-center shadow-[0_35px_60px_-15px_rgba(0,0,0,0.2)]  border-2 border-gray-600 rounded-md'>
                    <h1 className="font-bold">Cart</h1>
